...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        GraphNode test9 = new GraphNode("TestNode9");
        GraphNode test10 = new GraphNode("TestNode10");
        GraphNode test11 = new GraphNode("TestNode11");
        GraphNode test12 = new GraphNode("TestNode12");
...
//        test8.addBidirectionalAdjacency(test1);
        ...
        helen.addAdjacency(test9);
        helen.addAdjacency(test10);
        helen.addAdjacency(test11);
        helen.addAdjacency(test12);
